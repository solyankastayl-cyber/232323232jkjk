...
Base URL: https://entry-timing-stack.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://entry-timing-stack.preview.emergentagent.com').rstrip('/')
